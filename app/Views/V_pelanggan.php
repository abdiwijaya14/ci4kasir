...
<body>
    ...
    <script>
        $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(hasil) {
                            if (hasil.status === 'success') {
                                ...
                                Swal.fire('Gagal menyimpan data: ' + JSON.stringify(hasil.errors));
                            }
                        },
            ...
            // Hapus Data
            $(document).on("click", ".hapusDataPelanggan", function() {
                ...
                if (confirm("Apakah Anda yakin ingin menghapus produk ini?")) {
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.status === 'success') {
                                Swal.fire('Produk berhasil dihapus!');
                                tampilProduk();
                            } else {
                ...
                $.ajax({
                    ...
                    success: function(hasil) {
                        if (hasil.status === 'success') {
                            ...
                            Swal.fire('Gagal memperbarui data: ' + JSON.stringify(hasil.errors));
                        }
                    },
                    error: function(xhr, status, error) {
                        Swal.fire('Terjadi kesalahan: ' + error);
